...
(function () {
    ...
    app('cookie', {
        set: function setItem(sKey, sValue, options) {
            options = options || {};
        ...
        get: function getItem(sKey, options) {
            options = options || {};
            ...
            if (val && options.json) {
                try {
                    ...
                    logger.error('cant\' parse cookie item');
                }
            }
            return val;
        },
        remove: function removeItem(sKey, options) {
            options = options || {};
